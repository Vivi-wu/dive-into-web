...
+ `visibility: hidden;` 仍然**占据着本来的空间**，尽管看不见，还在影响着页面布局。
...
<table>
  ...
  <tbody>
    <tr>
      <td>inline-block</td><td>使元素成为一个行内级别、可封装块级元素。<span class="t-blue">使用该属性值可以轻松取代旧的利用 float:left; 方式实现的 a grid of boxes 填充满浏览器的效果</span></td>
    </tr>
    <tr>
