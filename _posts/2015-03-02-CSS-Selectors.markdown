...
能够对**基于文档树之外的信息**进行选择。Pseudo-class 名称是 **case-insensitive**

1. 链接 `:link` 和 `:visited`。
2. 用户操作 `:hover`, `:active`, 和 `:focus`
...
创建文档树上抽象的节点，allow authors to refer to this otherwise inaccessible information。
